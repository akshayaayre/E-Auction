package com.eauction.buyer.filter;

import com.eauction.buyer.entity.UserDetails;
...
//            httpRes.setHeader("Access-Control-Allow-Origin", "http://localhost:8080");
        ...
        try {
            ...
            if (userDetails != null && userDetails.getEmail() != null
                    && userDetails.getUserType() != null && userDetails.getUserType().equalsIgnoreCase("Buyer")) {
